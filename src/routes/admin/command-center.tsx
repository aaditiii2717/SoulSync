                 ...
                 {sessions.map(session => (
                    <Card key={session.id} className="p-4 border-none shadow-sm bg-white rounded-2xl relative overflow-hidden">
                       ...
                       <div className="mt-3 flex gap-2">
                          <Button size="xs" variant="ghost" className="h-7 text-[10px] font-black uppercase text-primary bg-primary/5 rounded-lg">Audit Briefing</Button>
                          <Button size="xs" variant="ghost" className="h-7 text-[10px] font-black uppercase text-slate-400 bg-slate-50 rounded-lg">Status: {session.status}</Button>
                       </div>
                    </Card>
                 ))}
              </div>
